...
if (HIDE_SYMBOLS AND NOT DEBUGMODE AND (CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_CLANG))
    ...
    if (CMAKE_SYSTEM_NAME MATCHES "Linux|kFreeBSD" OR CMAKE_SYSTEM_NAME STREQUAL "GNU")
        ...
        if (NOT PY2_VISIBILITY_MAP_FILE)
            set (PY2_VISIBILITY_MAP_FILE "${PROJECT_SOURCE_DIR}/src/build-scripts/hidesymbols_python2.map")
        endif ()
        set (PY2_VISIBILITY_MAP_COMMAND "-Wl,--version-script=${PY2_VISIBILITY_MAP_FILE}")
        if (VERBOSE)
            message (STATUS "PY2_VISIBILITY_MAP_COMMAND = ${PY2_VISIBILITY_MAP_COMMAND}")
        endif ()
        if (NOT PY3_VISIBILITY_MAP_FILE)
            set (PY3_VISIBILITY_MAP_FILE "${PROJECT_SOURCE_DIR}/src/build-scripts/hidesymbols_python3.map")
        endif ()
        set (PY3_VISIBILITY_MAP_COMMAND "-Wl,--version-script=${PY3_VISIBILITY_MAP_FILE}")
        if (VERBOSE)
            message (STATUS "PY3_VISIBILITY_MAP_COMMAND = ${PY3_VISIBILITY_MAP_COMMAND}")
        endif ()
    endif ()
endif ()
